...
resourcestring
  ...
  rsThisWillAttachTheDebuggerOfGameFuqRToTheCurrent = 'This will attach the debugger of Game FuqR to the current process.';
  rsDoNotCloseCE = 'If you close Game FuqR while the game is running, the game will close too. Are you sure you want to do this?';
  rsContinue = 'Continue?';
...
begin
  ...
  begin
    ...
    if @DebugActiveProcessStop=@DebugActiveProcessStopProstitute then
      mes:=rsThisWillAttachTheDebuggerOfGameFuqRToTheCurrent+' '+rsDoNotCloseCE
    else
    {$endif}
      mes:=rsThisWillAttachTheDebuggerOfGameFuqRToTheCurrent+' '+rsContinue;
