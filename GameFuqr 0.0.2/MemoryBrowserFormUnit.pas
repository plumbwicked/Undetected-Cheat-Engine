...
resourcestring
  ...
  rsGameFuqRSingleLingeAssembler = 'Single-line assembler';
...
//this will add the selected recdord to the list
  hexview.AddSelectedAddressToGameFuqRTable;
...
//  copy
  ...
  assemblercode:=InputboxTop(rsGameFuqRSingleLingeAssembler, Format(rsTypeYourAssemblerCodeHereAddress, [inttohex(Address, 8)]), assemblercode, x='', canceled{$ifndef darwin},assemblerHistory{$endif});
