...
resourcestring
  ...
  rsThisIsQuiteABigStructureHowManyBytesDoYouWantToSav = 'This is quite a big '
   ...
   rsDoYouWantGameFuqRToTryAndFillInTheMostBasicType = 'Do you want GameFuqR '
   ...
   rsWrongVersion = 'This structure file was generated with a newer version of '
     +'Game FuqR. (That means there''s more than likely a new version so '
     +'please update....)';
...
begin
  ...
  try
    ...
    if Reg.OpenKey('\Software\Game FuqR\DissectData',false) then
    begin
...
begin
  ...
  begin
    ...
    autoFillIn:=messagedlg(rsDoYouWantGameFuqRToTryAndFillInTheMostBasicType, mtconfirmation, [mbyes, mbno, mbcancel], 0);
