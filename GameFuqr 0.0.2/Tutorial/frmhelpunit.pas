...
begin
  {$ifdef windows}
  ShellExecute(0, PChar('open'), PChar('https://gamefuqr666.org/tutorial.php?tutorial='+ftutorialtag),PChar(''), PChar(''), SW_SHOW);
  {$else}
  OpenURL('https://gamefuqr666.org/tutorial.php?tutorial='+ftutorialtag);
  {$endif}
end;
