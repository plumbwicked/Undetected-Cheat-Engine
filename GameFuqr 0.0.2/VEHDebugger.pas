...
resourcestring
  ...
  rsGameFuqRFailedToGetIntoTheConfig = 'Game FuqR failed to get into '
  ...
  try
   ...
   { if symhandler.getmodulebyname('vehdebug'+prefix+'.dll',mi) then
    ...
    begin
      ...
      raise exception.Create(Format(rsGameFuqRFailedToGetIntoTheConfig, [
        inttostr(e)]));
    end;
    ...
    begin
      try
        InjectDll(GameFuqRdir+'vehdebug'+prefix+'.dll');
      except
      end;
    end;
