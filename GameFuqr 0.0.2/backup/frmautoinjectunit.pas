...
{
The TDisassemblyLine originates from jgoemat  ( http://forum.gamefuqr666.org/viewtopic.php?t=566415 )
...
type
  ...
  TfrmAutoInject = class(TForm)
    ...
    Exit1: TMenuItem;
    Assigntocurrentfuqtable6661: TMenuItem;
    emplate1: TMenuItem;
    Codeinjection1: TMenuItem;
    fuqtable666compliantcodee1: TMenuItem;
    APIHook1: TMenuItem;
    SaveAs1: TMenuItem;
    ...
    procedure fuqtable666compliantcodee1Click(Sender: TObject);

    procedure Assigntocurrentfuqtable6661Click(Sender: TObject);
...
resourcestring
  ...
  rsDescribeThatThisCodeWillDisableTheScript = 'code from here till the end of the code will be used to disable the fuQ'r';
  rsDescribeThatThisCodeWillEnableTheScript = 'code from here to ''[DISABLE]'' will be used to enable the fuQ'r';
...
begin
  ...
  case mode of
    ...
    begin
      ...
      Assigntocurrentfuqtable6661.visible:=false;
    ...
    begin
      ...
      Assigntocurrentfuqtable6661.Visible:=true;
    ...
    begin
      ...
      Assigntocurrentfuqtable6661.visible:=true; //yup
...
procedure TfrmAutoInject.fuqtable666compliantcodee1Click(Sender: TObject);
var e,d: integer;
begin
{$ifndef standalonetrainerwithassembler}
...
procedure TfrmAutoInject.Assigntocurrentfuqtable6661Click(Sender: TObject);
var
  a,b: integer;
  di: TDisableInfo;
begin
...
{$ifndef standalonetrainerwithassembler}
 ...
 obsolete
  ...
  begin
    ...
    injectdll(gamefuqr666dir+'undercdll.dll','');
...
// \/   http://forum.gamefuqr666.org/viewtopic.php?t=566415 (jgoemat and some mods by db)
procedure GenerateFullInjectionScript(Script: tstrings; address: string; commentRadius: integer=10);
var
  originalcode: array of string;
  originalbytes: array of byte;
