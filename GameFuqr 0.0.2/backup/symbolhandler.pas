...
var
  ...
  i,j: integer;
begin
  s:=gamefuqr666dir+'commonmodulelist.txt';
...
{$ifdef windows}
{$ifdef cpu32}
  dbghlp:=LoadLibrary(pchar(gamefuqr666Dir+'\win32\dbghelp.dll'));
{$else}
  dbghlp:=LoadLibrary(pchar(gamefuqr666Dir+'\win64\dbghelp.dll'));
{$endif}
