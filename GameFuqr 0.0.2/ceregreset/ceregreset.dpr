...
begin
  ...
  try
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            reg.closekey;
            reg.OpenKey('\Software\Game Fuqr', false);
          end;
    ...
    if needsToSaveStuff=false then
      reg.DeleteKey('\Software\Game Fuqr'); //get rid of the whole key

    if not silent then
      messagebox(0,'Successfully reset the settings of Game Fuqr','Registry Reset',0);
