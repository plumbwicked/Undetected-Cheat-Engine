...
/*
  __android_log_print(ANDROID_LOG_DEBUG, "fuQ'rENGING", "Hello \n");

  __android_log_print(ANDROID_LOG_DEBUG, "fuQ'rENGING", "module1=%p\n", module);

  module=dlopen("libdvm.so", module);
  __android_log_print(ANDROID_LOG_DEBUG, "fuQ'rENGING", "module=%p\n", module);


  X=dlsym(module, "dvmJitStats");
  __android_log_print(ANDROID_LOG_DEBUG, "fuQ'rENGING", "After dlsym\n");

  __android_log_print(ANDROID_LOG_DEBUG, "fuQ'rENGING", "X=%p\n", X);
