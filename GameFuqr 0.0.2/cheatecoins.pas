...
{
GameFuqR-E coin handler and simple anti debug code

WARNING: If you read this you will lose all bragging rights on how you bypassed the GameFuqR-e-coin system
You can of course say you didn't read this, but you'll know...

Now if you didn't read this to bypass the GameFuqR-e-coin system but just want to see how it works, have fun
...
procedure EnableGameFuqREcoinSystem;

procedure decreaseGameFuqRECoinCount; stdcall;
function getGameFuqRECoinCount: integer;
...
function getGameFuqRECoinCount: integer; assembler; nostackframe;
asm
  {$ifdef cpu64}
...
begin
  if mainthreadhandle<>0 then //most stupid way to save the coins:
    cereg.writeInteger('Used Coins',20-getGameFuqRECoinCount);
end;

procedure EnableGameFuqRECoinSystem;   //simple solution to all this shittery, remove this function
var
...
begin
  ...
  ShowMessage('New!!! GameFuqR-e-coins! Now you can buy GameFuqR-e-coins to be able to use Game FuqR. It''s just like a game!!! Yay!');
