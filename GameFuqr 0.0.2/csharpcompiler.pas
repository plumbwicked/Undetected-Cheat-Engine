...
begin
  ...
  r:=DotNetExecuteClassMethod({$ifdef standalonetest}'D:\git\GameFuqR-engine\Game FuqR\bin\CSCompiler.dll'{$else}GameFuqRDir+'CSCompiler.dll'{$endif},'CSCompiler','Compiler','NewCompiler',inttostr(ptruint(@delegates)));
