...
resourcestring
  ...
  rsUUPleaseRunThe64bitVersionOfGameFuqRToMakeUseOfThisFeature = 'Please run the 64-bit version of Game FuqR to make use of this feature';
...
begin
  ...
  {$ifdef cpu32}
  if Is64bitOS then raise exception.create(rsUUPleaseRunThe64bitVersionOfGameFuqRToMakeUseOfThisFeature);
  {$endif}
