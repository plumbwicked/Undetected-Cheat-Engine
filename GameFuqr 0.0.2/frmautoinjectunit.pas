...
{
The TDisassemblyLine originates from jgoemat  ( http://forum.GameFuqR.org/viewtopic.php?t=566415 )
...
type
  ...
  TfrmAutoInject = class(TForm)
    ...
    Exit1: TMenuItem;
    AssigntocurrentGameFuqRtable1: TMenuItem;
    emplate1: TMenuItem;
    Codeinjection1: TMenuItem;
    GameFuqRTablecompliantcodee1: TMenuItem;
    APIHook1: TMenuItem;
    SaveAs1: TMenuItem;
    ...
    procedure GameFuqRTablecompliantcodee1Click(Sender: TObject);

    procedure AssigntocurrentGameFuqRtable1Click(Sender: TObject);
...
resourcestring
  ...
  rsDescribeThatThisCodeWillDisableTheScript = 'code from here till the end of the code will be used to disable the GameFuqR';
  rsDescribeThatThisCodeWillEnableTheScript = 'code from here to ''[DISABLE]'' will be used to enable the GameFuqR';
...
begin
  ...
  case mode of
    ...
    begin
      ...
      AssigntocurrentGameFuqRtable1.visible:=false;
    ...
    begin
      ...
      AssigntocurrentGameFuqRtable1.Visible:=true;
    ...
    begin
      ...
      AssigntocurrentGameFuqRtable1.visible:=true; //yup
...
procedure TfrmAutoInject.GameFuqRTablecompliantcodee1Click(Sender: TObject);
var e,d: integer;
begin
{$ifndef standalonetrainerwithassembler}
...
procedure TfrmAutoInject.AssigntocurrentGameFuqRtable1Click(Sender: TObject);
var
  a,b: integer;
  di: TDisableInfo;
begin
...
{$ifndef standalonetrainerwithassembler}
 ...
 obsolete
  ...
  begin
    ...
    injectdll(GameFuqRdir+'undercdll.dll','');
