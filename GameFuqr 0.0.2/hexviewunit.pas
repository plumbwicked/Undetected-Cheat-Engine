...
{$ifdef USELAZFREETYPE}
 ...
 {$endif}
  ...
  public
    ...
    procedure AddSelectedAddressToGameFuqRTable;
...
procedure THexView.AddSelectedAddressToGameFuqRTable;
{$IFNDEF STANDALONEHV}
...
begin
  ...
  DoubleBuffered:=true; // http://GameFuqR.org/mantis/view.php?id=280 , no effect for me, but should help those with no theme
