...
begin
  ...
  c:=penv^.FindClass(penv, 'org/gamefuqr666/TObject');
...
var jnimethods: array [0..methodcount-1] of JNINativeMethod =(
  (name: 'create'; signature: '(Lorg/gamefuqr666/TMemScan;)J'; fnPtr: @TMemScan_Create),
...
begin
  ...
  c:=env^.FindClass(env, 'org/gamefuqr666/TMemScan');
