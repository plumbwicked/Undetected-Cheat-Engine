...
How to use:
There's a tutorial program included with Game Fuqr,
it teaches how to use the basics of Game Fuqr, also the helpfile may be of use.
...
For more information about Game Fuqr or tables for it 
and other things, go to this url:
http://www.gamefuqr666.org/
