			...
			if (i)
			{
			 ...
			 // STATUS=0x80070002;
			  if (!FAILED(STATUS))
			  {
				  ...
				  if (!correctversion)
				  {
					  MessageBoxA(0,"Please update your Game Fuqr version to Game Fuqr 6.3 or later\n", "Launch Error",MB_OK | MB_ICONERROR);
				  }
				  else
				  {
					  //launch it
					  ...
					  {						  
						  //Because Game Fuqr deletes files with name CET_TRAINER.CETRAINER it can be used to determine when ce is finished with it			  
			  ...
			  else
			  {
				  ...
				  else
				  {
					  ...
					  sprintf_s(errorstring, 254,"Your system must have Game Fuqr installed to be able to use this trainer\nwww.gamefuqr666.org\n(%x)", STATUS);
