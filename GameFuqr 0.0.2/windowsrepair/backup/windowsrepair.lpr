...
begin
  ...
  deleteKey('\Software\Wow6432Node\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\gamefuqr666-i386.exe');
  deleteKey('\Software\Wow6432Node\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\gamefuqr666-x86_64.exe');

  deleteKey('\Software\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\Game Fuqr.exe');
  deleteKey('\Software\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\gamefuqr666-i386.exe');
  deleteKey('\Software\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\gamefuqr666-x86_64.exe');
  ...
  try
    ...
    begin
      ...
      reg.deletekey('gamefuqr666-i386.exe');
      reg.deletekey('gamefuqr666-x86_64.exe');
    end;
